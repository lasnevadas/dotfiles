...
#Define the greeter
echo '▓▓▓▒▒▒▒▒░░░ネバーダーAvenita Intelligent Systems 1999-2015'
echo 'When we are fully cleansed and the truth comes forth, will we listen?'
...
setprompt() {
  ...
  # set the prompt
  PS1=$'${PR_CYAN}[${PR_USER}${PR_BLUE}:>${PR_BLUE}]${PR_USER_OP} '
  PS2=$'%_>'
